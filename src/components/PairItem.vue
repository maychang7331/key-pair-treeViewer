...
div(:key="pair.id" class="px-5 py-2 flex")
  div(class="grid grid-cols-2 gap-4 flex-grow mr-3")
    input(type="text" v-model="key" :placeholder="pair.key" class="bg-transparent outline-none border  border-slate-500 text-base px-2 py-1 w-full placeholder-slate-200")
